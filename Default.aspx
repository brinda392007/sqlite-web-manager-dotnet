...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="min-h-screen bg-slate-900 p-8 text-white">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div class="col-span-2 rounded-lg border border-slate-700 bg-slate-800 p-6 shadow-xl">
                <div class="mb-6 flex items-center justify-between">
                    <h2 class="text-xl font-bold text-orange-400">Encrypted Storage</h2>
            ...
            <div class="rounded-lg border border-slate-700 bg-slate-800 p-6 shadow-xl">
                ...
                <a href="Upload.aspx" class="mb-3 block w-full rounded border border-slate-600 bg-slate-700 py-3 text-center text-white transition hover:bg-slate-600">
                    Upload New File
                </a>
                <a href="#" class="block w-full rounded border border-slate-600 bg-slate-700 py-3 text-center text-white transition hover:bg-slate-600">
                    View Analytics
                </a>
            </div>
            <div class="rounded-lg border border-slate-700 bg-slate-800 p-6 shadow-xl">
                <h2 class="mb-4 text-xl font-bold text-orange-400">Logs</h2>
                <div id="log-panel" class="my mb-3 w-full overflow-auto rounded border bg-slate-900 py-3">
                    hello<br />
                    hello<br />
                    hello<br />
                    hello<br />
