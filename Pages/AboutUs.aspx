                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="Register.aspx" class="nav-button px-6 py-2 rounded-lg font-semibold text-white transition-all"
                           style="background: linear-gradient(135deg, #f97316 0%, #fb923c 100%); box-shadow: 0 4px 14px 0 rgba(249, 115, 22, 0.39);">
                            Register
                        </a>
                    </div>
                </div>
               ...
               <!-- <div class="mb-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="Register.aspx" class="px-8 py-4 rounded-lg font-bold text-lg text-white transition-all transform hover:scale-105"
                       style="background: linear-gradient(135deg, #f97316 0%, #fb923c 100%); box-shadow: 0 10px 30px -10px rgba(249, 115, 22, 0.5);">
                        Get Started Free
                    </a>
                ...
                <div class="backdrop-blur-lg rounded-2xl p-8 md:p-12 border" style="background: #1e293b; border-color: #334155;">
                    ...
                    <div class="mb-6 text-center">
                        <p class="text-slate-400">
                            Emails sent this session: <span class="font-bold text-white"><asp:Label ID="lblEmailCount" runat="server" Text="0"></asp:Label>/5</span>
                        </p>
