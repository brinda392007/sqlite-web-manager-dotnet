    ...
    <form id="form1" runat="server">
        ...
        <section class="relative overflow-hidden py-20 px-4">
            ...
            <div class="max-w-6xl mx-auto relative z-10">
                ...
                <p class="text-xl md:text-2xl text-slate-300 max-w-3xl">
                    Automating Database Development with Smart Code Generation
                </p>
            </div>
        </section>
        ...
        <footer class="py-8 px-4 text-center text-slate-400 border-t" style="border-color: #334155;">
            <!--<p class="mb-2">&copy; 2024 ASPWebSM. All rights reserved.</p>-->
